...
echo "<td><center>" . number_format($total_stars_friends/$friends_weight,2) . "</td>";
echo "<td><center>" . number_format($total_stars_friends_adj/$friends_weight,2) . "</td>";
echo "</tr>";
echo "<tr>";
...
echo "<td><center>" . number_format($funny_votes/$funny_weight,2) . "</td>";
echo "<td><center>" . number_format($funny_votes_adj/$funny_weight,2) . "</td>";
echo "</tr>";
echo "<tr>";
echo "<td><center>" . "Useful" . "</td>";
echo "<td><center>" . number_format($useful_votes/$useful_weight,2) . "</td>";
echo "<td><center>" . number_format($useful_votes_adj/$useful_weight,2) . "</td>";
echo "</tr>";
echo "<tr>";
echo "<td><center>" . "Cool" . "</td>";
echo "<td><center>" . number_format($cool_votes/$cool_weight,2) . "</td>";
echo "<td><center>" . number_format($cool_votes_adj/$cool_weight,2) . "</td>";
echo "</tr>";
echo "<tr>";
...
echo "<td><center>" . number_format($breakfast_stars/$breakfast,2) . "</td>";
echo "<td><center>" . number_format($breakfast_stars_adj/$breakfast,2) . "</td>";
echo "</tr>";
echo "<tr>";
echo "<td><center>" . "Lunch" . "</td>";
echo "<td><center>" . number_format($lunch_stars/$lunch,2) . "</td>";
echo "<td><center>" . number_format($lunch_stars_adj/$lunch,2) . "</td>";
echo "</tr>";
echo "<tr>";
echo "<td><center>" . "Dinner" . "</td>";
echo "<td><center>" . number_format($dinner_stars/$dinner,2) . "</td>";
echo "<td><center>" . number_format($dinner_stars_adj/$dinner,2) . "</td>";
echo "</tr>";
echo "</table>";
?>
</body>
